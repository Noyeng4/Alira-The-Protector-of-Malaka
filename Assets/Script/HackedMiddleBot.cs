...
private void Awake()
{
    ...
    private void HandleTargeting()
    {
        ...
        GameObject nearestTarget = GetNearestTarget(enemies, middleBots, heavyBosses);
    ...
    private GameObject GetNearestTarget(GameObject[] enemies, GameObject[] middleBots, GameObject[] heavyBosses)
    {
        ...
        foreach (GameObject heavyBoss in heavyBosses)
        {
            ...
            if (distanceToHeavyBoss < shortestDistance)
            {
                shortestDistance = distanceToHeavyBoss;
                nearestTarget = heavyBoss;
            }
        }
